define([
	...
	'dojo/dom-construct',
	'dojo/dom-class'
], function(declare, lang, array, evt, connect, query, dom, css){
	...
	return declare("nano.rotator.Controller", null, {
		// summary:
		...
		// example:
		//	|	<div dojoType="nano.rotator.Controller"
		//	|		rotator="myRotator"
		//	|	></div>
		// example:
		//	|	<div dojoType="nano.rotator.Controller"
		...
		constructor: function(/*Object*/params, /*DomNode|string*/node){
			...
			if(r){
				...
				var ul = this._domNode = dom.create("ul", null, node),
		...
		_buildInfo: function(/*nano.Rotator*/r){
			// summary:
