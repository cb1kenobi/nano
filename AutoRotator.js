define([
	...
	"dojo/_base/array",
	"./Rotator"
], function(declare, lang, connect, array, Rotator){

return declare("nano.AutoRotator", Rotator,{
	// summary:
	//		A rotator that automatically transitions between child nodes.
	// description:
	//		Adds automatic rotating to the nano.Rotator.  The
	...
	//		pane.
	// example:
	//	|	<div dojoType="nano.AutoRotator" duration="3000">
	//	|		<div>
	//	|			Pane 1!
	//	|		</div>
	//	|		<div duration="5000">
  ...
  constructor: function(){
	...
	//		Initializes the timer and connect to the rotator.
			...
			_t._connects = [
				connect.connect(_t._domNode, "onmouseover", function(){
				...
				connect.connect(_t._domNode, "onmouseout", function(){
		...
		_cycle: function(/*Boolean|int?*/manual){
			...
			if(def){
				def.then(function(/*Boolean?*/skipDuration){
					_t.onUpdate("cycle");
					if(_t.playing){
